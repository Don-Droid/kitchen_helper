...
#    Apr 15, 2021 05:49:47 PM EDT  platform: Windows NT
...
def vp_start_gui():
    ...
    global val, w, root
    root = tk.Tk()
    recipe_support.set_Tk_var()
    top = Toplevel1 (root)
    recipe_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    recipe_support.set_Tk_var()
    top = Toplevel1 (w)
    recipe_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Frame1.place(relx=0.033, rely=0.044, relheight=0.9, relwidth=0.908)
        ...
        self.Button1.place(relx=0.044, rely=0.914, height=24, width=52)
        self.Button1.configure(activebackground="#ececec")
        self.Button1.configure(activeforeground="#000000")
        self.Button1.configure(background="#6dd47e")
        self.Button1.configure(command=recipe_support.rback)
        ...
        ToolTip(self.Button1, self.tooltip_font, '''Previous Recipe''')

        self.Button2 = tk.Button(self.Frame1)
        self.Button2.place(relx=0.866, rely=0.914, height=24, width=52)
        self.Button2.configure(activebackground="#ececec")
        self.Button2.configure(activeforeground="#000000")
        self.Button2.configure(background="#6dd47e")
        self.Button2.configure(command=recipe_support.next)
        ...
        ToolTip(self.Button2, self.tooltip_font, '''Next Recipe''')

        self.Scrolledlistbox1 = ScrolledListBox(self.Frame1)
        self.Scrolledlistbox1.place(relx=0.534, rely=0.151, relheight=0.407
                , relwidth=0.429)
        ...
        self.Scrolledlistbox1.configure(listvariable=recipe_support.pantry)

        self.Scrolledlistbox2 = ScrolledListBox(self.Frame1)
        self.Scrolledlistbox2.place(relx=0.046, rely=0.151, relheight=0.407
                , relwidth=0.429)
        ...
        self.Scrolledlistbox2.configure(listvariable=recipe_support.ingre)

        self.Scrolledlistbox3 = ScrolledListBox(self.Frame1)
        self.Scrolledlistbox3.place(relx=0.044, rely=0.642, relheight=0.235
                , relwidth=0.917)
        self.Scrolledlistbox3.configure(background="#ffd55a")
        ...
        self.Scrolledlistbox3.configure(listvariable=recipe_support.method)

        self.Labelframe1_1 = tk.LabelFrame(self.Frame1)
        self.Labelframe1_1.place(relx=0.035, rely=0.593, relheight=0.062
                , relwidth=0.934)
        self.Labelframe1_1.configure(relief='groove')
        self.Labelframe1_1.configure(font="-family {Segoe UI} -size 9 -weight bold")
        self.Labelframe1_1.configure(foreground="white")
        self.Labelframe1_1.configure(text='''Method''')
        ...
        self.Labelframe1.place(relx=0.037, rely=0.099, relheight=0.062
                , relwidth=0.45)
        self.Labelframe1.configure(relief='groove')
        self.Labelframe1.configure(font="-family {Segoe UI} -size 9 -weight bold")
        self.Labelframe1.configure(foreground="white")
        self.Labelframe1.configure(text='''Ingredients''')
        self.Labelframe1.configure(background="#293250")
        self.Labelframe1.configure(highlightbackground="#d9d9d9")
        self.Labelframe1.configure(highlightcolor="black")

        self.Labelframe1_2 = tk.LabelFrame(self.Frame1)
        self.Labelframe1_2.place(relx=0.523, rely=0.099, relheight=0.062
                , relwidth=0.45)
        self.Labelframe1_2.configure(relief='groove')
        self.Labelframe1_2.configure(font="-family {Segoe UI} -size 9 -weight bold")
        self.Labelframe1_2.configure(foreground="white")
        self.Labelframe1_2.configure(text='''Pantry Items''')
        self.Labelframe1_2.configure(background="#293250")
        self.Labelframe1_2.configure(highlightbackground="#d9d9d9")
        self.Labelframe1_2.configure(highlightcolor="black")

        self.Label1 = tk.Label(self.Frame1)
        self.Label1.place(relx=0.037, rely=0.025, height=21, width=499)
        ...
        self.Label1.configure(textvariable=recipe_support.title)

        self.Button3 = tk.Button(self.Frame1)
        self.Button3.place(relx=0.275, rely=0.914, height=24, width=85)
        self.Button3.configure(activebackground="#ececec")
        self.Button3.configure(activeforeground="#000000")
        self.Button3.configure(background="#6dd47e")
        self.Button3.configure(command=recipe_support.prepare)
        ...
        self.Button3.configure(text='''Prepare Meal''')
        self.tooltip_font = "TkDefaultFont"
        self.Button3_tooltip = \
        ToolTip(self.Button3, self.tooltip_font, '''Prepare Meal''')

        self.Button4 = tk.Button(self.Frame1)
        self.Button4.place(relx=0.571, rely=0.914, height=24, width=85)
        self.Button4.configure(activebackground="#ececec")
        self.Button4.configure(activeforeground="#000000")
        self.Button4.configure(background="#6dd47e")
        self.Button4.configure(command=recipe_support.shoppingList)
        ...
        self.Button4.configure(text='''Shopping List''')
        self.tooltip_font = "TkDefaultFont"
        self.Button4_tooltip = \
        ToolTip(self.Button4, self.tooltip_font, '''Generate Shopping List''')

        self.Button5 = tk.Button(self.Frame1)
        self.Button5.place(relx=0.02, rely=0.025, height=24, width=57)
        self.Button5.configure(activebackground="#ececec")
        self.Button5.configure(activeforeground="#000000")
        self.Button5.configure(background="#d9d9d9")
        self.Button5.configure(command=recipe_support.back)
