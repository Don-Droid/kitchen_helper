...
#    Apr 15, 2021 05:13:33 PM EDT  platform: Windows NT
...
import shopping_support

def vp_start_gui():
    '''Starting point when module is the main routine.'''
    global val, w, root
    root = tk.Tk()
    shopping_support.set_Tk_var()
    top = Toplevel1 (root)
    shopping_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    shopping_support.set_Tk_var()
    top = Toplevel1 (w)
    shopping_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        top.resizable(1,  1)
        top.title("Shopping List ")
        top.configure(background="#293250")

        self.Frame1 = tk.Frame(top)
        self.Frame1.place(relx=0.038, rely=0.051, relheight=0.9, relwidth=0.925)
        ...
        self.Scrolledlistbox1.place(relx=0.114, rely=0.123, relheight=0.63
                , relwidth=0.36)
        ...
        self.Scrolledlistbox1.configure(listvariable=shopping_support.needed)

        self.Scrolledlistbox2 = ScrolledListBox(self.Frame1)
        self.Scrolledlistbox2.place(relx=0.523, rely=0.123, relheight=0.63
                , relwidth=0.36)
        ...
        self.Scrolledlistbox2.configure(listvariable=shopping_support.pantry)

        self.Label1 = tk.Label(self.Frame1)
        self.Label1.place(relx=0.595, rely=0.044, height=30, width=114)
        self.Label1.configure(background="#293250")
        self.Label1.configure(disabledforeground="#a3a3a3")
        self.Label1.configure(font="-family {Segoe UI} -size 10 -weight bold")
        self.Label1.configure(foreground="#ffffff")
        self.Label1.configure(text='''Pantry Items''')

        self.Label2 = tk.Label(self.Frame1)
        self.Label2.place(relx=0.162, rely=0.044, height=30, width=144)
        self.Label2.configure(background="#293250")
        self.Label2.configure(disabledforeground="#a3a3a3")
        self.Label2.configure(font="-family {Segoe UI} -size 10 -weight bold")
        self.Label2.configure(foreground="#ffffff")
        self.Label2.configure(text='''Items Needed''')

        self.Button1 = tk.Button(self.Frame1)
        self.Button1.place(relx=0.378, rely=0.847, height=26, width=137)
        self.Button1.configure(activebackground="#ececec")
        self.Button1.configure(activeforeground="#000000")
        self.Button1.configure(background="#6dd47e")
        self.Button1.configure(command=shopping_support.generate)
        ...
        self.Button1.configure(text='''Generate List''')

        self.Button2 = tk.Button(self.Frame1)
        self.Button2.place(relx=0.02, rely=0.025, height=24, width=57)
        self.Button2.configure(activebackground="#ececec")
        self.Button2.configure(activeforeground="#000000")
        self.Button2.configure(background="#d9d9d9")
        self.Button2.configure(command=shopping_support.back)
