...
#    May 15, 2021 08:49:19 PM EDT  platform: Windows NT
...
def vp_start_gui():
    ...
    global val, w, root
    root = tk.Tk()
    ypantry_support.set_Tk_var()
    top = Toplevel1 (root)
    ypantry_support.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    ypantry_support.set_Tk_var()
    top = Toplevel1 (w)
    ypantry_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.TLabel1.place(relx=0.275, rely=0.051, height=21, width=264)
        self.TLabel1.configure(background="#293250")
        self.TLabel1.configure(foreground="#ffffff")
        self.TLabel1.configure(font="-family {Stencil} -size 12")
        self.TLabel1.configure(relief="flat")
        self.TLabel1.configure(anchor='center')
        self.TLabel1.configure(justify='center')
        self.TLabel1.configure(text='''Your Pantry''')

        self.Scrolledlistbox1 = ScrolledListBox(self.Frame1)
        self.Scrolledlistbox1.place(relx=0.128, rely=0.182, relheight=0.59
                , relwidth=0.758)
        ...
        self.Scrolledlistbox1.configure(listvariable=ypantry_support.plist)

        self.Button1 = tk.Button(self.Frame1)
        self.Button1.place(relx=0.136, rely=0.843, height=34, width=87)
        self.Button1.configure(activebackground="#ececec")
        self.Button1.configure(activeforeground="#000000")
        self.Button1.configure(background="#6dd47e")
        self.Button1.configure(command=ypantry_support.add)
        ...
        ToolTip(self.Button1, self.tooltip_font, '''Add an Item''')

        self.Button1_1 = tk.Button(self.Frame1)
        self.Button1_1.place(relx=0.73, rely=0.843, height=34, width=87)
        self.Button1_1.configure(activebackground="#ececec")
        self.Button1_1.configure(activeforeground="#000000")
        self.Button1_1.configure(background="#ffd55a")
        self.Button1_1.configure(command=ypantry_support.remove)
        ...
        ToolTip(self.Button1_1, self.tooltip_font, '''Delete selected items''')

        self.Label1 = tk.Label(self.Frame1)
        self.Label1.place(relx=0.128, rely=0.127, height=21, width=414)
        ...
        self.Label1.configure(text='''Item                               Quantity                               Unit''')

        self.Button2 = tk.Button(self.Frame1)
        self.Button2.place(relx=0.02, rely=0.025, height=30, width=77)
        self.Button2.configure(activebackground="#ececec")
        self.Button2.configure(activeforeground="#000000")
        self.Button2.configure(background="#d9d9d9")
        self.Button2.configure(command=ypantry_support.back)
